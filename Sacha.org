...
***** Track time
 ...
 #+begin_src emacs-lisp :tangle yes
   (use-package org
    :custom-face
     (org-todo ((t (:background "black" :foreground "green"))))
    :init
    (progn
...
#+begin_src emacs-lisp :tangle yes
  ...
  (defvar my/shell-scripts-directory (file-name-directory "~/bin"))
  (unless (file-exists-p my/shell-scripts-directory)
    (my/convert-shell-scripts-to-interactive-commands my/shell-scripts-directory))
#+end_src
